...
<body>
  ...
  <!-- Links -->
	...
	<div class="background">
		<h2>Find Colleges</h2><br>
		<form method="post" action="home.php">
			<div id="center">
				<input class="ip" type="text" name="board" placeholder="12th Board's Percentage" required><br><br>
				...
				<input class="ip" type="text" name="bvp" placeholder="BVPCET Score"><br><br>
			...
			if(isset($_POST['submit']))
			{
				...
				if($_SERVER["REQUEST_METHOD"] == "POST")
				{
					...
					else
					{
						...
						if($bvp>140)
							echo "You are eligible to apply for Bharati Vidyaapeeth Demeed University<br>";
						if($vit>80)
